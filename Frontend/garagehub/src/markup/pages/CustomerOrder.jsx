              ...
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <p className="text-muted">
                    ...
                    request. Below, you can find details about your order,
                    including the status of each requested service, customer
                    information, and vehicle details. Check back anytime for
                    ...
                    <div className="d-flex flex-column gap-3">
                      {singleOrderData.order_services.map((service, index) => (
                        ...
                        >
                          ...
                          <div>
                            <h4 className="mb-1">{service.service_name}</h4>
                            <p className="text-muted">
